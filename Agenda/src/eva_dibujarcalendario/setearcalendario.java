...
public class setearcalendario{
			...
			//instanciar calendarioactual
			
					public setearcalendario(){
					...
					public  int getmes(GregorianCalendar mical){
					...
					public void  setmes(GregorianCalendar mical,int mesconf){
					...
					public void ndiasmes(GregorianCalendar mical){
